...
import { ArrowUpRight, Sparkles, LayoutGrid, ChevronRight, Map } from "lucide-react";
...
export default function ExplorePage() {
  ...
  const displayItems = exploreMenu.find(cat => cat.category === selectedCategory)?.items || [];

  return (
    <main id="other" className="relative bg-gray-50 dark:bg-[#050505] text-gray-900 dark:text-white font-sans transition-colors duration-300 pt-20 pb-6 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="mb-3 border-b border-gray-200 dark:border-white/5 pb-8">
           <div className="space-y-4 max-w-3xl">
              ...
              >
                Explore <span className="text-transparent bg-clip-text bg-linear-to-r from-lime-500 to-emerald-600">Everything.</span>
              </motion.h1>
              ...
              >
                Pusat navigasi untuk mengakses seluruh halaman, layanan, dan ekosistem digital yang tersedia. Pilih kategori untuk memulai.
              </motion.p>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
          <div className="lg:col-span-1 space-y-2 lg:sticky lg:top-32">
            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 px-2">Kategori Menu</h3>
               ...
               return (
                 ...
                 >
                    <div className="flex items-center gap-3 relative z-10">
                       <section.icon size={18} className={isActive ? "text-black" : "text-gray-400 group-hover:text-lime-500 transition-colors"} />
                   ...
                   {displayItems.map((item, idx) => {
                      ...
                      return (
                        ...
                        >
                           ...
                           >
                              <div className="w-12 h-12 shrink-0 rounded-xl bg-gray-50 dark:bg-white/5 flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-lime-500 group-hover:text-white transition-all duration-300 shadow-inner">
                              ...
                              <div className="flex-1 min-w-0">
                                 <div className="flex justify-between items-center mb-1">
                                    ...
                                    <ArrowUpRight size={14} className="text-gray-300 opacity-0 -translate-x-2 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300" />
                                 </div>

                                 <div className="flex items-center">
                                    {item.badge ? (
                                      <span className={`text-[9px] font-bold uppercase px-1.5 py-0.5 rounded border tracking-wide ${getBadgeStyle(item.badge)}`}>
                                         {item.badge}
                                      </span>
                                    ) : (
