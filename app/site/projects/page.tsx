...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="relative py-24 bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white font-sans overflow-hidden transition-colors duration-300">
      <ProductOverlay isOpen={isProductOpen} onClose={() => setIsProductOpen(false)} products={products} />
      <TutorialModal isOpen={isTutorialOpen} onClose={() => setIsTutorialOpen(false)} />

      <div className="relative max-w-7xl mx-auto px-6 z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className="text-center lg:text-left space-y-8" data-aos="fade-right">
           ...
           <div className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-3 text-sm text-gray-500 dark:text-gray-500 font-bold">
              <div className="flex items-center gap-2"><CheckCircle2 size={18} className="text-lime-600 dark:text-lime-500"/> 100% Kode Original</div>
              <div className="flex items-center gap-2"><CheckCircle2 size={18} className="text-lime-600 dark:text-lime-500"/> Garansi Terjamin</div>
              <div className="flex items-center gap-2"><CheckCircle2 size={18} className="text-lime-600 dark:text-lime-500"/> Akses Mudah</div>
           </div>
           ...
           <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-6">
              ...
              >
                {loading ? <Loader2 className="animate-spin" size={18}/> : <>Lihat Semua Produk <ArrowRight size={18} /></>}
              </button>
        ...
        <div className="relative w-full aspect-square md:aspect-video rounded-4xl overflow-hidden border border-gray-200 dark:border-white/10 shadow-2xl group bg-gray-50 dark:bg-[#111]" data-aos="fade-left" data-aos-delay="200">
             ...
             <AnimatePresence mode="wait">
                ...
                >
                   ...
                   <div className="absolute inset-0 bg-linear-to-t from-gray-900 via-gray-900/40 to-transparent opacity-90 dark:opacity-80"></div>
                </motion.div>
             </AnimatePresence>

             <div className="absolute bottom-0 left-0 w-full p-8 md:p-10 z-20 flex flex-col justify-end items-start gap-3">
