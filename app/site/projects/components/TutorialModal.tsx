        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-10000 p-4 pointer-events-none">
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-[#101012]">
                <div className="flex items-center gap-2">
                  <div className="p-1.5 bg-lime-100 dark:bg-lime-500/10 rounded-lg text-lime-600 dark:text-lime-400">
                    <BookOpen size={18} />
                  </div>
                  <h3 className="text-gray-900 dark:text-white font-bold text-sm">Panduan dan Langkah - Langkah Pembelian</h3>
                </div>
                <button 
                  onClick={onClose} 
              ...
              <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar">
                <div className="space-y-4">
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={idx} className="flex gap-3 text-sm text-gray-600 dark:text-gray-300 items-start group">
                ...
                <div className="p-4 bg-red-50 dark:bg-red-500/5 border border-red-100 dark:border-red-500/10 rounded-xl space-y-3">
                   ...
                   <div className="space-y-2 pl-1">
                     {[
                       ...
                       <p key={idx} className="text-[11px] text-gray-600 dark:text-gray-400 flex gap-2 leading-relaxed">
                         <span className="text-red-500 shrink-0 mt-0.5">•</span> {rule}
                       </p>
                     ))}
                   </div>
                </div>
