...
const TrackRecord = () => {
  ...
  return (
    <section id="education" className="px-4 py-15 bg-white dark:bg-[#0a0a0a] md:px-8 max-w-[1600px] mx-auto overflow-hidden">
            ...
            {visibleOrganization.map((org, idx) => (
              ...
              >
                ...
                <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-800 flex items-center justify-between">
                   <span className="text-[10px] text-neutral-400">Lihat Selengkapnya</span>
                   <IconArrowRight />
                </div>
              </Link>
            ))}
            ...
            <div className="flex justify-center mt-8 relative z-10">
                ...
                >
                    <span className="text-sm font-bold text-gray-700 dark:text-neutral-300 group-hover:text-lime-600 dark:group-hover:text-lime-400">
                        {isOrgExpanded ? 'Persingkat' : `Lihat ${organizationData.length - 4}+ Organisasi Lainnya`}
                    </span>
                    <svg 
      ...
      <div className="animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
         ...
         {experienceData.length > 5 && (
            <div className="flex justify-center mt-8 relative z-10">
                ...
                >
                    <span className="text-sm font-bold text-gray-700 dark:text-neutral-300 group-hover:text-lime-600 dark:group-hover:text-lime-400">
                        {isExpExpanded ? 'Persingkat' : `Lihat ${experienceData.length - 5}+ Pengalaman Lainnya)`}
                    </span>
                    <svg 
