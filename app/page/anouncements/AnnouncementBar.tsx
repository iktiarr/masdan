    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed top-15 left-0 w-full z-100 isolate"
        >
          {/* Background Gradient Premium */}
          <div className="relative bg-linear-to-r from-lime-600 via-emerald-600 to-green-700 text-white overflow-hidden shadow-xl">
            ...
            <div className="max-w-7xl mx-auto px-4 h-10 md:h-12 flex items-center justify-center relative z-10">
              ...
              >
                <div className="flex items-center gap-1.5 bg-white/20 px-2 py-0.5 rounded-full border border-white/20 backdrop-blur-sm">
                  ...
                  <span className="uppercase text-[9px]">New Update</span>
                </div>
